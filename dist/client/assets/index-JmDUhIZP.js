...
var client_browser = { exports: {} };
var reactServerDomWebpackClient_browser_production = {};
...
var hasRequiredReactServerDomWebpackClient_browser_production;
function requireReactServerDomWebpackClient_browser_production() {
  if (hasRequiredReactServerDomWebpackClient_browser_production) return reactServerDomWebpackClient_browser_production;
  hasRequiredReactServerDomWebpackClient_browser_production = 1;
  ...
  function createBoundServerReference(metaData, callServer2) {
    function action() {
      var args = Array.prototype.slice.call(arguments);
      return bound ? "fulfilled" === bound.status ? callServer2(id, bound.value.concat(args)) : Promise.resolve(bound).then(function(boundArgs) {
        return callServer2(id, boundArgs.concat(args));
      }) : callServer2(id, args);
    }
  ...
  function ResponseInstance(bundlerConfig, serverReferenceConfig, moduleLoading, callServer2, encodeFormAction, nonce, temporaryReferences) {
    var chunks = /* @__PURE__ */ new Map();
    this._bundlerConfig = bundlerConfig;
    this._serverReferenceConfig = serverReferenceConfig;
    this._moduleLoading = moduleLoading;
    this._callServer = void 0 !== callServer2 ? callServer2 : missingCall;
      ...
      for (var rowTag = streamState._rowTag, rowLength = streamState._rowLength, buffer = streamState._buffer, chunkLength = value.length; i < chunkLength; ) {
        ...
        if (-1 < lastIdx)
          rowLength = new Uint8Array(value.buffer, offset, lastIdx - i), processFullBinaryRow(
            ...
            buffer,
            rowLength
          ), i = lastIdx, 3 === rowState && i++, rowLength = _ref2 = rowTag = rowState = 0, buffer.length = 0;
        else {
  ...
  reactServerDomWebpackClient_browser_production.createFromFetch = function(promiseForResponse, options) {
  ...
  reactServerDomWebpackClient_browser_production.createFromReadableStream = function(stream, options) {
    options = createResponseFromOptions(options);
    startReadingFromStream(options, stream, close.bind(null, options));
    return getChunk(options, 0);
  };
  reactServerDomWebpackClient_browser_production.createServerReference = function(id, callServer2) {
    function action() {
      var args = Array.prototype.slice.call(arguments);
      return callServer2(id, args);
    }
    registerBoundServerReference(action, id, null);
    return action;
  };
  reactServerDomWebpackClient_browser_production.createTemporaryReferenceSet = function() {
    return /* @__PURE__ */ new Map();
  };
  reactServerDomWebpackClient_browser_production.encodeReply = function(value, options) {
  ...
  reactServerDomWebpackClient_browser_production.registerServerReference = function(reference, id) {
    registerBoundServerReference(reference, id, null);
    return reference;
  };
  return reactServerDomWebpackClient_browser_production;
}
var hasRequiredClient_browser;
function requireClient_browser() {
  if (hasRequiredClient_browser) return client_browser.exports;
  hasRequiredClient_browser = 1;
  {
    client_browser.exports = requireReactServerDomWebpackClient_browser_production();
  }
  return client_browser.exports;
}
var client_browserExports = requireClient_browser();
function createFromReadableStream(stream, options = {}) {
  return client_browserExports.createFromReadableStream(stream, {
    callServer,
    findSourceMapURL,
    ...options
  });
...
function createFromFetch(promiseForResponse, options = {}) {
  return client_browserExports.createFromFetch(promiseForResponse, {
    callServer,
    findSourceMapURL,
    ...options
  });
}
const encodeReply = client_browserExports.encodeReply;
...
const createTemporaryReferenceSet = client_browserExports.createTemporaryReferenceSet;
...
const clientReferences = {
  "569ca76b06e4": async () => {
    const m = await __vitePreload(() => import("./worker-entry-qTUOVscA.js"), true ? [] : void 0);
...
function GlobalErrorBoundary(props) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(ErrorBoundary, { errorComponent: DefaultGlobalErrorPage, children: props.children });
}
class ErrorBoundary extends React.Component {
  ...
  render() {
    ...
    if (error) {
      return /* @__PURE__ */ jsxRuntimeExports.jsx(this.props.errorComponent, { error, reset: this.reset });
    }
...
function DefaultGlobalErrorPage(props) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("html", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("head", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("title", { children: "Unexpected Error" }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "body",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: "Caught an unexpected error" }),
...
function createRscRenderRequest(urlString, action) {
...
async function main() {
  let setPayload;
  const initialPayload = await createFromReadableStream(
  ...
  const browserRoot = /* @__PURE__ */ jsxRuntimeExports.jsx(React.StrictMode, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(GlobalErrorBoundary, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(BrowserRoot, {}) }) });
  if ("__NO_HYDRATE" in globalThis) {
    clientExports.createRoot(document).render(browserRoot);
  } else {
    clientExports.hydrateRoot(document, browserRoot, {
